...
<div class="col-lg-4 mt-6 cart-wrap ftco-animate col-25" style='width:30%;margin-top:0;margin-left:50px;margin-right:60px'>
          ...
          <div class="cart-total mb-5">
            <center>
              ...
              <p class="d-flex">
    						<span style="font-family:verdana;margin-left:20px;margin-right:100px"> Subtotal : </span>
    						<span style="color:red">${{$total}}</span>
    					</p>
    					<p class="d-flex">
    						<span style="font-family: verdana;margin-left:20px;margin-right:100px">Delivery :</span>
    						<span style="color:red">$0.00</span>
    					</p>
    					<p class="d-flex">
    						<span style="font-family: verdana;margin-left:20px;margin-right:100px">Discount :</span>
    						<span style="color:red">$0.00</span>
    					</p>
    					<hr>
...
<h2>Shipping Detail</h2>
            ...
            <div class=" print-error-msg" style="display:none;margin-left:100px;color:red;font-weight:bold">
                        <ul></ul>
            </div>

            <a href="{{route('cart')}}"><button type="submit" class="button button3" id=""style="margin-left:52px;width:45%;margin-top:50px;">Back to Cart</button></a>
            <button type="submit" class="button button3" id="n"style="margin-left:52px;width:45%;margin-top:50px;"><a style="color:black">Confirm Order</a></button>
