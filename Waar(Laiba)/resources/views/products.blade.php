...
<!-- products-breadcrumb -->
	...
	<div class="banner">
		...
		@foreach($k as $cat)
		<center>
		<h2 style="margin-bottom:2%;margin-top:3%;margin-left:5%">{{$cat->SubCatType}}</h2>
        </center>
		<div style="display:flex;flex-direction:row;">
		@foreach($cat->product as $elements)
		<div class="card-group " style="margin-left:2%;margin-right:2%;margin-top:3%;display:flex;display:flex;" >
			  ...
			  <div style="margin-top:1%;display:flex;width:100%">
                <input class="box1" type="button" value="Add To Cart"style="margin-top:4%;height:34px;border:none;margin-right:4px;font-size:16px;margin-left:10px;width:80%">				
				<input class="box1" type ="button" value="❤️"style="height:34px;border:none;margin-right:9px;width:20%;margin-left:2px;font-size:20px"/>
				</div>
